<?php
namespace Thao\HidePrice\Block\View\Contact;

/**
 * Interceptor class for @see \Thao\HidePrice\Block\View\Contact
 */
class Interceptor extends \Thao\HidePrice\Block\View\Contact implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isHidePrice');
        return $pluginInfo ? $this->___callPlugins('isHidePrice', func_get_args(), $pluginInfo) : parent::isHidePrice();
    }
